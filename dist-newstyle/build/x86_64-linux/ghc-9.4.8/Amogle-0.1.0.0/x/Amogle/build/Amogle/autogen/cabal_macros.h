...
/* package Amogle-0.1.0.0 */
#ifndef VERSION_Amogle
#define VERSION_Amogle "0.1.0.0"
#endif /* VERSION_Amogle */
#ifndef MIN_VERSION_Amogle
#define MIN_VERSION_Amogle(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Amogle */
...
#define CURRENT_COMPONENT_ID "Amogle-0.1.0.0-inplace-Amogle"
